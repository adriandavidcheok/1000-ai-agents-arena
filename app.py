...
st.markdown("**Version 137.0 — New key hardcoded + FREE qwen/qwen3-coder:free**")
st.info("✅ Using FREE qwen/qwen3-coder model (lower rate limits than Hermes)")
...
# OpenRouter client with your NEW key hardcoded
client = OpenAI(
    api_key="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",
...
# (The rest of the app — approve, writing, halted stages — is identical to the previous full versions with all logging, verifier, deduplication, etc.)

st.caption("💡 Version 137.0 — New key + FREE qwen/qwen3-coder model. Paste this complete code and hard-refresh the page.")
